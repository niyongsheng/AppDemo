...
- (void)configTheme {
    ...
    self.conversationMessageCollectionView.lee_theme.LeeConfigBackgroundColor(@"common_bg_color_1");
    
    self.chatSessionInputBarControl.inputContainerView.lee_theme.LeeConfigBackgroundColor(@"common_bg_color_2");
    
    self.chatSessionInputBarControl.inputTextView.lee_theme.LeeConfigBackgroundColor(@"common_bg_color_2");
}
