...
- (NYSAutoscrollImageView *)generatImageView {
    UIImage *image = [UIImage imageNamed:@"scrollView"];
    
//    if ([[LEETheme currentThemeTag] isEqualToString:NIGHT]) {
//        [image imageByBlurDark];
//    } else {
//        [image imageByBlurLight];
//    }
    
    NYSAutoscrollImageView *imageView = [[NYSAutoscrollImageView alloc] initWithImage:image];
